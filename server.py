                ...
                if not word.disabled:  # if the word is not out of screen
                    ...
                    for client_id in self.players:
                        if self.players[client_id].word_submit != " ":
                            if (self.players[client_id].word_submit == word.word) and (
                            not word.disabled):  # if the typing is correct plus the score
                                ...
                                print(self.players[
                                          client_id].word_submit + "!=" + word.word)  # not the word that the user type
                else:
                    removed_words.append(word)
